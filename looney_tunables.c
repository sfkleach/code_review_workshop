...
static bool
fetch_next_tunable_from_var(char * tunables, char **ename, char **evalue, char **next_tunables) {
...
parse_tunables(char *sanitized_tunables, char *original_tunables)
{
    ...
    char *value;
    char *next_tunables;
    while (fetch_next_tunable_from_var(current_tunables, &name, &value, &next_tunables)) {
